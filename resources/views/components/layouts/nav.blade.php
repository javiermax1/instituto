<nav class="h-nav bg-nav max-2xl:bg-accent flex flex-row justify-start items-center space-x-5 px-5">
    <a href="{{route('main')}}" class="btn btn-glass text-header">Main</a>
